...
diagnostics, export — on a synthetic (mock) dataset, so you can run every
step yourself without needing real patient data.
...
-   :material-view-grid-outline:{ .lg .middle } **Case Study 2 · Spectral Features** <small>(coming soon)</small>

    ---

    A more exploratory approach: mass-univariate and cluster-based
    statistics applied to spectral EEG features, trading interpretability
    for sensitivity to distributed or atypical effects.

    [:octicons-arrow-right-24: Read more](case_study_2.md)
